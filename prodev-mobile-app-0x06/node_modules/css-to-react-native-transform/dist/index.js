...
var transform = function transform(css, options) {
  ...
  for (var r in rules) {
    ...
    for (var s in rule.selectors) {
      ...
      if (typeof (options === null || options === void 0 ? void 0 : options.ignoreRule) === "function" && options.ignoreRule(rule.selectors[s]) === true) {
        continue;
      }
    ...
    if (rule.type == "media" && options != null && options.parseMediaQueries === true) {
      ...
      for (var _r in rule.rules) {
        ...
        for (var _s in ruleRule.selectors) {
          if (typeof (options === null || options === void 0 ? void 0 : options.ignoreRule) === "function" && options.ignoreRule(ruleRule.selectors[_s]) === true) {
            continue;
          }
