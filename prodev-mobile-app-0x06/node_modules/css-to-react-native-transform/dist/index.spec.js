...
describe("misc", function () {
  ...
  it("allows uppercase units", function () {
    expect((0, _index["default"])("\n      .test {\n        top: 0PX\n      }\n      ")).toEqual({
      test: {
        top: 0
      }
...
describe("border", function () {
  it("transforms border none", function () {
    expect((0, _index["default"])("\n      .test {\n        border: none\n      }\n      ")).toEqual({
      test: {
        borderWidth: 0,
        borderColor: "black",
  ...
  it("transforms border for unsupported units", function () {
  ...
  it("does not transform border with percentage width", function () {
    expect(function () {
...
describe("font", function () {
  ...
  it("transforms multiple font variant as an array", function () {
...
describe("flex-box", function () {
  ...
  */
  ...
  it("transforms flex shorthand with flex-basis set to percent", function () {
    expect((0, _index["default"])("\n      .test {\n        flex: 1 2 30%\n      }\n      ")).toEqual({
      test: {
        flexGrow: 1,
        flexShrink: 2,
  ...
  it("transforms flex shorthand with flex-basis set to unsupported unit", function () {
    expect((0, _index["default"])("\n      .test {\n        flex: 1 2 30em\n      }\n      ")).toEqual({
      test: {
        flexGrow: 1,
        flexShrink: 2,
...
describe("font", function () {
  ...
  it("does not allow line height as multiple", function () {
    expect(function () {
...
it("transforms place content", function () {
...
it("transforms place content with one value", function () {
...
it("does not allow justify content without align content", function () {
  expect(function () {
...
describe("ignoreRule option", function () {
  it("should allow to ignore a selector completely", function () {
    expect((0, _index["default"])("\n      .foo {\n        color: red;\n      }\n      .bar {\n        font-size: 12px;\n      }\n    ", {
      ignoreRule: function ignoreRule(selector) {
        if (selector === ".foo") {
          return true;
        }
      }
  ...
  it("should do nothing when returing false", function () {
    expect((0, _index["default"])("\n        .foo {\n          color: red;\n        }\n        .bar {\n          font-size: 12px;\n        }\n    ", {
      ignoreRule: function ignoreRule(selector) {
        if (selector === ".bar") {
          return false;
  ...
  it("should not error out even if ignoreRule is not a function", function () {
    expect((0, _index["default"])("\n        .foo {\n          color: red;\n        }\n        .bar {\n          font-size: 12px;\n        }\n      ", {
      ignoreRule: true
    })).toEqual({
      bar: {
...
describe("media queries", function () {
  ...
  it("should support media queries + ignoreRule option", function () {
    expect((0, _index["default"])("\n        .container {\n          background-color: #f00;\n        }\n\n        @media (orientation: landscape) {\n          .container {\n            background-color: #00f;\n          }\n        }\n        ", {
      ignoreRule: function ignoreRule(selector) {
